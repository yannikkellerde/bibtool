...
from backend import bib_handler
...
@app.route('/bibliography/styles/<path:path>')
def send_style(path):
    return send_from_directory('styles', path)

@app.route('/bibliography/js/<path:path>')
def send_js(path):
    return send_from_directory('js', path)

@app.route('/bibliography/pdfs/<path:path>')
def send_pdf(path):
    return send_from_directory('pdfs', path)


@app.route('/bibliography/bib.csv')
def send_bib():
